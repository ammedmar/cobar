...
%We will use this observation together with the result, proven in the next section, that $\M$ is Hopf to provide $\coAlg_\UM$ with a monoidal structure and prove in ... that $\cchainsUM$ is monoidal.
