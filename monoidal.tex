...
We remark that Day convolution can be defined for general presheaves over a monoidal category. Namely, if $(\mathsf{J}, \boxtimes)$ is a monoidal category, we may define a monoidal structure
\[ 
...
\anibal{$\Fun(\cdot)$ not $\Fun[\cdot]$ and categories are always \texttt{mathsf}}

\anibal{don't write the formula again, just explain how this specializes to $\cSet$}
