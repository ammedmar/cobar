...
The functor of (simplicial) \textit{chains} $\schains \colon \cSet \to \Ch$ is the Kan extension along the Yoneda embedding of the functor $\triangle \to \Ch$ assigning to an object $[n]$ the chain complex having in degree $m$ the module
\begin{equation*}
...
The functor of (cubical) \textit{chains} $\cchains \colon \cSet \to \Ch$ is the Kan extension along the Yoneda embedding of the functor $\cube \to \Ch$ assigning to an object $2^n$ the chain complex having in degree $m$ the module
\begin{equation*}
