\begin{abstract}
	...
	We also show that, for a general reduced simplicial set $X$, Hess--Tonks' extended cobar construction on $\schains(X)$ is quasi-isomorphic to $\schains(\kan(X))$, the chains on the Kan loop group of $X$, as an $E_{\infty}$-coalgebra. 
\end{abstract}