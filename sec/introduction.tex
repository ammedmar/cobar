...
We turn now to a second result in this work, which is concerned with a classical combinatorial model for the based loop space described by Kan in the framework of reduced simplicial sets.
...
\anibal{Why are this operators mentioned?}
...
\anibal{Note to self: The subscript should be $\As$ but that collides with the $\Ahat$ notation.}
...
\anibal{This makes it sound that the previous as $E_\infty$-coalgebras this was done before.}
...
\anibal{I am not sure if this is a good last sentence. PS, this IS the introduction (referring to the last fragment)}
