...
\end{tikzcd}
\]
%Furthermore, when $(Z,z)$ is a pointed space, Adams' comparison map $\theta_Z \colon \cobar \sSchainsA(Z,z) \to \cSchains(\loops_z Z)$ is a quasi-isomorphism of bialgebras.
