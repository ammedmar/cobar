...
\begin{proposition}[\cite{adams1956cobar}\cite{rivera2018cubical}]
...
\anibal{Express this with more generality so that one case gives Baues and the other our theorem}
