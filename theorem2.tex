...
Our comparison uses the rigidification functor, a construction used by Lurie in the theory of $\inty$-categories, as a middle object to relate the Kan loop group and the cubical cobar construction. The rigidification functor is naturally isomorphic to the triangulation of the cubical cobar construction, as explained in \cref{Candgcobar}. Then, in \cref{CandG}, we show that a localized version of the rigidification functor agrees, up to homotopy, with the Kan loop group. Our main result then follows by applying the c

Then we relate both the Kan loop group functor and the extended cobar construction to a localized version of the rigidification functor, which receiving maps from both.
...
\anibal{Display equations need to be at least in the form:} \\
\verb|\[| \\
\verb|math| \\
\verb|\]|
