...
\thanks{A.M. acknowledges financial support from Innosuisse grant \mbox{32875.1 IP-ICT - 1} and the hospitality of the Laboratory for Topology and Neuroscience at EPFL where part of this work developed.}
\author{Manuel Rivera}
\address{Department of Mathematics, Purdue University, West Lafayette, IN, USA}
\email{manuelr@purdue.edu}
\thanks{M.R. acknowledges support from the \textit{Karen EDGE Fellowship} \anibal{Foundation?} and the excellent working conditions of the \textit{Max Planck Institute for Mathematics} in Bonn, Germany.}
